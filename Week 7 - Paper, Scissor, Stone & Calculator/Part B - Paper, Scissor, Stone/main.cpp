...
/*
 * void getWinner (enum Elements elements1, enum Elements elements2)
 *  compare the 2 parameters passed from the main() arguments to decide who is the winner
